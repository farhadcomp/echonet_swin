...
OUTPUT_DIR="output/video/swin_resized_data"
...
echo "========================================="
echo " Starting Training: Swin with new Dataset"
echo "========================================="
...
CUDA_VISIBLE_DEVICES=0,1 echonet video --num_epochs 1 --batch_size 16 --num_workers 4 --lr 1e-4 --period 3 --output ${OUTPUT_DIR} 2>&1 | tee ${TRAIN_LOG}
